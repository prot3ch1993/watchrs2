    ...
    return (
        <>
            {datas.map((movie, index) => (
                <div className="col-2 trendingMovie" style={{ backgroundImage: `url(${getImage(movie.poster_path)})` }} key={index} data-bs-toggle="modal" data-bs-target={"#a" + index + movie.id}>
                    <h1><span>{index + 1}</span></h1>
